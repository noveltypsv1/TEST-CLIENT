...
public class Jframe extends Client implements ActionListener {
	...
	public void initUI(int width, int height, boolean resizable) {
		try {
		    ...
		    public void windowClosing(WindowEvent we) { 
		        ...
		        int userPrompt = JOptionPane.showOptionDialog(null, "Are you sure you wish to exit?", "NoveltyPS",
		        		JOptionPane.DEFAULT_OPTION, JOptionPane.WARNING_MESSAGE, null, options , options[1]);
		        if(userPrompt == JOptionPane.YES_OPTION) {
		       // openURL("http://NoveltyPS.net");
		        	  System.exit(-1);
		            System.exit(0);
		        } else {
	...
	public void initializeMenuBar() {
		 ...
		 * Create our buttons
		 */
		JButton homeButton = createButton("Home", "House_icon.png", "Open the official NoveltyPS homepage.");
		JButton forumsButton = createButton("Forum", "forums.png", "Open the official NoveltyPS forums.");

		JButton knowledgeBaseButton = createButton("Knowledge Base", "3366503.gif", "Open the NoveltyPS Knowledge Base on the forums.");
		JButton storeButton = createButton("Store", "cart_icon.gif", "Open the official NoveltyPS store.");
		JButton voteButton = createButton("Vote", "Small-checkmark.png", "Open the official NoveltyPS voting page.");
		JButton scoresButton = createButton("HiScores", "hiscores.png", "Open the official NoveltyPS Hiscores");

		JButton tsButton = createButton("Join Discord", "discord.png", "Join the NoveltyPS discord.");
		...
		try {
			if (cmd != null) {
				...
				case "Join Discord":
					...
					openURL("https://discord.gg/DaApYwz");
					break;
				}
