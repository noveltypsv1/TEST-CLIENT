...
public class RSInterface {
	...
	public static void Pets(TextDrawingArea atextdrawingarea[])
 {
     ...
     addText(3210, "NoveltyPS Point Shop", atextdrawingarea, 3, 0xffcc33, false, true);
     ...
     addText(3276, "Kill ::ixwarriors To Obtain NoveltyPS Points!", atextdrawingarea, 3, 0xffcc33, false, true);
	...
	public static void newStarter(TextDrawingArea[] tda) {
		...
		addText(52752, "NoveltyPS Account Setup", 0xff9933, true, true, 52, tda, 3);
		...
		addText(52764, "Play NoveltyPS as an Iron man.", 0xff9933, true, true, 52, tda, 0);
	...
	addHoveredButton(37437, "Interfaces/Tele/TBUTTONS/BH", 11, 81, 34, 37638);
					...
					addText(50430, "NoveltyPS Teleports", fonts, 2, 0xff9040, true, true); //rename it whatever
	...
	addHoveredButton(38433, "Interfaces/Tele/DBUTTONS/BH", 9, 81, 34, 38634);
					...
					addText(50430, "NoveltyPS Teleports", fonts, 2, 0xff9040, true, true);
...
public static void TeleTAB5() {
	...
	public static void playersOnline(TextDrawingArea[] tda) {
		...
		addText(57007, "NoveltyPS", 0xff9933, true, true, -1, tda, 0);
		...
		while (stream.currentOffset < stream.buffer.length) {
			...
			if (rsInterface.type == 4) {
				rsInterface.message = stream.readString().replaceAll(
						"RuneScape", "NoveltyPS");
				if(rsInterface.message.toLowerCase().equals("the bank of NoveltyPS")) {
					rsInterface.message = "        The Bank of NoveltyPS";
				}
...
//          
    ...
    public static void statistics1(final TextDrawingArea[] tda) {
        ...
        addText(id + 3, "NoveltyPS", 0xAF6A1B, false, true, 0, tda, 2);
...
//End of Drop Table Interfaces
	private static void questTabInterface() {
		...
		addText(39155, "NoveltyPS.net", fonts, 2, 16750623, false, true);
...
public static void addHoverSpriteLoaderButton(int i, int spriteId,
	...
	public static void dropPreview(TextDrawingArea[] tda) {
		...
		addText(47902, "Begin item:", 0xff9933, true, true, -1, tda, 2);
		//addText(74503, "Current Defender: Rune", 0xff9933, false, true, -1, tda, 0);
		addText(47904, "Dropping:", 0xff9933, false, true, -1, tda, 0);
		//addTransparentSpriteWSpriteLoader(74501, 970, 130);
		addText(47916, "End Item", 0xff9933, true, true, -1, tda, 2);
		//addText(74503, "Current Defender: Rune", 0xff9933, false, true, -1, tda, 0);
		addText(47917, "Dropping:", 0xff9933, false, true, -1, tda, 0);
		addText(47919, "Requirements", 0xff9933, true, true, -1, tda, 2);

		addText(47927, "Upgrade x1", 0xff9933, true, true, -1, tda, 2);
		addText(47928, "Upgrade x5", 0xff9933, true, true, -1, tda, 2);
		addText(47929, "Upgrade all", 0xff9933, true, true, -1, tda, 2);
