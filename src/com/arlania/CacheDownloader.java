...
public class CacheDownloader implements Runnable {
	...
	*/
	//https://www.dropbox.com/s/whoxq7vbzshi5qr/liquidX.zip?dl=0
	...
	private void unZipFile(File zipFile, File outFile) throws IOException {
		g.setStatus("Unzipping Novelty-PSCache...");
		g.setPercent(0);
	...
	private File downloadCache() {
		g.setStatus("Downloading Novelty-PSCache...");

		File ret = new File(CACHE_PATH + "NoveltyPSCache.zip");
	...
	public class GUI extends JFrame {
		...
		private void initComponents() {
			...
			setTitle("NoveltyPS Cache  Update");
