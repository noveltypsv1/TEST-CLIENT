...
if exist "%HOMEDRIVE%/C:\Program Files\Java\jdk1.8.0_131/bin/" goto x786
...
"%HOMEDRIVE%/C:\Program Files\Java\jdk1.8.0_131/bin/java.exe" -Xmx512m -jar Oblivion.jar cmdline
pause
exit
